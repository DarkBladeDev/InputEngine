...
public class HudConfigScreen extends Screen {
    ...
    public HudConfigScreen() {
        super(Text.literal("InputEngine HUD Config"));
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.fill(x, y, x + 68, y + 20, 0x80000000);
        context.drawText(this.textRenderer, "HUD Area", x + 5, y + 6, 0xFFFFFF, false);
        
        context.drawCenteredTextWithShadow(this.textRenderer, "Drag the HUD Area to move it. Press ESC to save.", this.width / 2, 20, 0xFFFFFF);
    }
